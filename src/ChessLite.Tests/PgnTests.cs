...
public class PgnTests
{
    ...
    [Test]
    public async Task Write_Mainline_FormatsMovetextWithResult()
    {
        var game = new Game();
    ...
    [Test]
    public async Task Write_Checkmate_AppendsHashAndResult()
    {
        var game = new Game();
    ...
    [Test]
    public async Task Write_Castling_UsesCastleNotation()
    {
        var game = new Game();
        game.MakeMove(Helpers.MoveFromUci(game.Position, "g1f3"));
    ...
    [Test]
    public async Task Write_EnPassant_UsesCaptureNotation()
    {
        var game = new Game();
        game.MakeMove(Helpers.MoveFromUci(game.Position, "e2e4"));
    ...
    [Test]
    public async Task Write_Promotion_UsesPromotionSuffix()
    {
        var game = new Game();
    ...
    [Test]
    public async Task Write_Check_UsesPlusSuffix()
    {
        var game = new Game();
        game.MakeMove(Helpers.MoveFromUci(game.Position, "e2e4"));
        game.MakeMove(Helpers.MoveFromUci(game.Position, "e7e5"));
    ...
    [Test]
    public async Task Write_DisambiguatesSameTargetRookMove()
    {
        var game = new Game();
        game.MakeMove(Helpers.MoveFromUci(game.Position, "e2e4"));
        game.MakeMove(Helpers.MoveFromUci(game.Position, "e7e5"));
    ...
    [Test]
    public async Task Write_DisambiguatesSameTargetKnightMoveByRank()
    {
        var game = new Game();
        game.MakeMove(Helpers.MoveFromUci(game.Position, "g1f3"));
        game.MakeMove(Helpers.MoveFromUci(game.Position, "a7a6"));
